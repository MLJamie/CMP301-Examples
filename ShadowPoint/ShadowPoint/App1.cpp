...
void App1::depthPass()
{
	...
	XMMATRIX rot = XMMatrixRotationY(45.0f);
	XMMATRIX lightViewMatrix = light->getViewMatrix();
	XMMATRIX lightProjectionMatrix = XMMatrixMultiply(light->getProjectionMatrix(), rot);
...
void App1::gui()
{
	...
	ImGui::SliderFloat3("Position", (float*)&position, -30.0f, 30.0f, "%.3f", 1.0f);
